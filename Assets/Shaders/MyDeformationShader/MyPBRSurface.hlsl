...
void InitializeSurfaceData(Varyings IN, out SurfaceData surfaceData)
{
    ...
    surfaceData.normalTS = SampleNormal(IN.uv, TEXTURE2D_ARGS(_BumpMap, sampler_BumpMap), _BumpScale); //this is included in the referenced HLSL file
    surfaceData.emission = SampleEmission(IN.uv, _EmissionColor.rgb, TEXTURE2D_ARGS(_EmissionMap, sampler_EmissionMap)); //this is included in the referenced HLSL file
